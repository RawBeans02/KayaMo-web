      ...
      <div className={styles.page}>
        ...
        <section className={`${styles.list} kgSurface`} aria-label="Data">
          ...
          <details className={styles.details}>
            ...
            <div className={styles.detailsBody}>
              <p>
                <strong>Your records.</strong> Demo entries are held in this browser and
                never reach a server. With an account, entries sync to your own row and
                are readable only by you.
              </p>
              <p>
                <strong>Lis.</strong> Lis reads only what a screen hands it for the
                question you asked, writes nothing without your confirmation, and never
                produces nutrition numbers itself. Those come from the food catalog.
              </p>
              <p>
                <strong>Accessibility.</strong> This app honours Reduce Motion, Reduce
                Transparency and Increase Contrast from your system, and the switch above
                overrides transparency for this browser. Every control is reachable by
                keyboard with a visible focus ring, targets are at least 44px, and text
                keeps a 4.5:1 contrast ratio on glass.
              </p>
              <p>
            ...
            <span className={styles.rowLabel}>
              ...
              <small className={styles.rowNote}>
                ...
                <a
                  ...
                  href={supportMailto('KayaMo account deletion')}
                >
                  {SUPPORT_EMAIL}
                </a>{' '}
        ...
        {guest ? (
          <p className={styles.status}>
            You are using the local demo. Demo entries will not transfer to an account.{' '}
