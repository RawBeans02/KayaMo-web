  ...
  return (
    <div className={`${styles.screen} ${styles.homeScreen}`}>
      <header className={styles.homeHeader}>
        ...
        <p className={styles.homeLead}>
          {welcomeBack
            ...
            : recommended
              ? 'One thing matters now. Lis is holding the rest.'
      ...
      <section className={styles.actionCard}>
        ...
        <p className={styles.muted}>{recommended ? 'Lis is reminding you, not changing your plan.' : 'Lis will not fill your day without you.'}</p>
      ...
      <section className={styles.inboxCapture}>
        ...
        <h3>Park it here</h3>
        <p className={styles.muted}>Private by default. Lis cannot read this until you allow it.</p>
  ...
  return (
    <div className={embedded ? styles.homeToday : `${styles.screen} ${styles.listScreen}`}>
      ...
      <section className={styles.focusSuggestion}>
        ...
        <h3>{plan ? `A 25-minute session on “${plan.selected_label_snapshot}” is the one Lis keeps suggesting.` : 'Choose one action and Lis can hold a quiet timer for it.'}</h3>
...
export function HealthScreen({
  ...
  return (
    <div className={`${styles.screen} ${styles.listScreen}`}>
      <AppScreenHeader
        title="Physical Self"
        subtitle={viewLogicalDate === todayLogical ? 'Food and gym live here. Numbers come from your records, not from Lis.' : 'You are looking at a past day.'}
        onChat={onChat}
        onBack={onBack}
      />
      <DayStrip todayLogical={todayLogical} selected={viewLogicalDate} marked={markedDays} onSelect={onSelectDay} />
...
export function TargetsDialog({
  ...
  return (
    <ActionDialog
      ...
      description="Generated in code from your confirmed records. Lis never sets these numbers."
    >
    ...
    <div className={`${styles.screen} ${styles.listScreen}`}>
      ...
      {faithEnabled ? (
        <section className={styles.faithCard}>
          ...
          <p className={styles.muted}>Lis can support reflection, but is not a theological authority.</p>
        </section>
      ) : (
